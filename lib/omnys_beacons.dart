...
class OmnysBeacons {
  ...
  static Future<BeaconsResult> checkStatus({
    ...
    LocationPermission permission = const LocationPermission(),
      ...
      _channel.checkStatus(_StatusRequest(
        ranging,
        monitoring,
        permission,
      ));
  ...
  static Stream<MonitoringResult> monitoring({
    ...
    return _channel.monitoring(_DataRequest(
      region,
      permission,
      inBackground,
    ));
  ...
  static Future<BeaconsResult> startMonitoring({
    ...
    assert(permission.ios == LocationPermissionIOS.always);
    return _channel.startMonitoring(_DataRequest(
      region,
      permission,
      inBackground,
    ));
  ...
  static final _Channels _channel = _Channels();
}
...
_log(String message, {String? tag}) {
  if (OmnysBeacons.loggingEnabled) {
