...
public final class StreamsChannel {
    ...
    private final class IncomingStreamRequestHandler implements BinaryMessageHandler {
        ...
        private final class EventSinkImplementation implements EventChannel.EventSink {
            ...
            private android.os.Handler uiThreadHandler  = new android.os.Handler(Looper.getMainLooper());
            ...
            public void success(Object event) {
                ...
                uiThreadHandler.post(() -> StreamsChannel.this.messenger.send(name, codec.encodeSuccessEnvelope(event)));
            }
            ...
            public void error(String errorCode, String errorMessage, Object errorDetails) {
                ...
                uiThreadHandler.post(() -> StreamsChannel.this.messenger.send(
                        name,
            ...
            public void endOfStream() {
                ...
                uiThreadHandler.post(() -> StreamsChannel.this.messenger.send(name, null));
            }
        }
    }
